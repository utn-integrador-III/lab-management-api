...
class LabController(Resource):
    ...
    def post(self, **kwargs):
        ...
        try:
            ...
            # Validate if the laboratory already exists by lab_num
            labs_exists = LabModel.get_by_num(data.get("lab_num"))
            if labs_exists:
                return ServerResponse(message='lab with this lab_num already exists', 
